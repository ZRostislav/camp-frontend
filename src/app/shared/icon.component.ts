...
const ICON_PATHS: Record<string, string> = {
  shield:
    'M12 2 4 5v6c0 5.2 3.4 9 8 11 4.6-2 8-5.8 8-11V5z',
  tent:
    'M3.5 21 12 3l8.5 18M3.5 21h17M7 21l5-10.5L17 21M12 13l2.5 8',
  user:
    'M12 12a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM4.5 21a7.5 7.5 0 0 1 15 0',
  lock:
    'M6 11V8a6 6 0 1 1 12 0v3 M5 11h14v9a1 1 0 0 1-1 1H6a1 1 0 0 1-1-1z',
  eye:
    'M2.5 12S5.5 5.5 12 5.5 21.5 12 21.5 12 18.5 18.5 12 18.5 2.5 12 2.5 12Z M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z',
  'eye-off':
  ...
  'log-in':
    'M10 17l5-5-5-5 M15 12H3 M15 4h4a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-4',
